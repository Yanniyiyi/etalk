...
public class LoginFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        TextView textView = (TextView) loginView.findViewById(R.id.forgetPassword);
        textView.setOnClickListener(this);

        ImageView backBtn = (ImageView) loginView.findViewById(R.id.back_to_main_page);
    ...
    public void onButtonPressed(int viewId) {
        if (mListener != null) {
            mListener.onLoginInteraction(viewId);
        }
    }
    ...
    public interface OnLoginInteractionListener {
        ...
        void onLoginInteraction(int viewId);
    }
